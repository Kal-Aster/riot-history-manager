...
var DOM_COMPONENT_INSTANCE_PROPERTY = __.globals.DOM_COMPONENT_INSTANCE_PROPERTY;
...
function isRouter(element) {
    return element.matches("router,[" + __.globals.IS_DIRECTIVE + "=\"router\"]");
}
...
function isRoute(element) {
    return element.matches("route,[" + __.globals.IS_DIRECTIVE + "=\"route\"]");
}
...
export { BASE, DOM_COMPONENT_INSTANCE_PROPERTY, LAST_ROUTED, PARENT_ROUTE, PARENT_ROUTER, ROUTER, UNROUTE_METHOD, claimLoadingBar, dispatchEventOver, endLoadingBar, getRoute, getRouter, hasLoadingBar, isRoute, isRouter };
